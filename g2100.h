...
#define ZG_MAC_SUBTYPE_MGMT_REQ_SET_PWR_MODE ((u8)7) // Added //P
...
#define ZG_PARAM_RADIO_ON_OFF (18) // NEW-Manually turn RF radio ON/OFF //P
// MAC result code
enum {
    ZG_RESULT_SUCCESS = 1,
...
void enable_low_power(boolean powerSave); //P
